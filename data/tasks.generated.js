window.TASK_LIBRARY = {
  ...
  "tasks": [
    ...
    },
    {
      ...
      "description": "Three robots must reach their targets through the warehouse.",
      "participant_prompt": "Run the scene, inspect what goes wrong, and decide whether the shared rulebook should be added to or refined.",
      "analysis": {
        "layer": 3,
        "prerequisites": [
    ...
    },
    {
      ...
      "family": "shared_rulebook_curriculum",
      "active_agent_count": 4,
      "description": "Four robots must reach their targets in a warehouse containing a machine.",
      "participant_prompt": "Run the scene, inspect what goes wrong, and decide whether the shared rulebook should be added to or refined.",
      "analysis": {
        "layer": 3,
        "prerequisites": [
    ...
    },
    {
      ...
      "family": "shared_rulebook_curriculum",
      "active_agent_count": 3,
      "description": "Three robots must reach their targets in a warehouse containing cold storage.",
      "participant_prompt": "Run the scene, inspect what goes wrong, and decide whether the shared rulebook should be added to or refined.",
      "analysis": {
        "layer": 3,
        "prerequisites": [
    ...
    },
    {
      ...
      "family": "shared_rulebook_curriculum",
      "active_agent_count": 4,
      "description": "Four robots must reach their targets in a warehouse containing cold storage and a machine.",
      "participant_prompt": "Run the scene, inspect what goes wrong, and decide whether the shared rulebook should be added to or refined.",
      "analysis": {
        "layer": 3,
        "prerequisites": [
    ...
    },
    {
      ...
      "family": "shared_rulebook_curriculum",
      "active_agent_count": 3,
      "description": "All robots must reach their targets in a warehouse containing cold storage and a machine.",
      "participant_prompt": "Run the scene, inspect what goes wrong, and decide whether the shared rulebook should be added to or refined.",
      "analysis": {
        "layer": 4,
        "prerequisites": [
